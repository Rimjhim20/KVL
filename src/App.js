       ...
       <div class="relative w-full">
        ...
        <form name="f1" id="f1">
          ...
          <div className="mb-8 ml-96">
            <input type="button" onClick={printpage} defaultValue="Click here to print the page" className=" border-4 cursor-pointer border-black w-auto p-2 font-bold bg-gradient-to-r from-blue text-pink-700	 text-xl   rounded-lg " />
